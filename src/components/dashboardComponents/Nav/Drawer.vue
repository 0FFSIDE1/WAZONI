          ...
          <li>
            ...
            <transition name="fade">
              <ul v-if="deliveryOpen" class="pl-6 mt-2 space-y-2 text-sm">
                ...
                <li><router-link to="/vendor/dashboard/track/"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
