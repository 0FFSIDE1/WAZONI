<template>
  ...
  <li class="p-4 pb-2 text-xs opacity-60 tracking-wide">These are your most recent customers</li>
  ...
  <li class="list-row">
    ...
    <div class="list-col-grow">
      <div>Mark Essien</div>
      <div class="text-xs uppercase font-semibold opacity-60">Mercedes</div>
    </div>
    <button class="btn btn-square btn-ghost">
      View
    </button>
  ...
  <li class="list-row">
    ...
    <div><img class="size-10 rounded-box" src="https://img.daisyui.com/images/profile/demo/3@94.webp"/></div>
    <div class="list-col-grow">
      <div>Gardener Williams</div>
      <div class="text-xs uppercase font-semibold opacity-60">Maggi</div>
    </div>
    <button class="btn btn-square btn-ghost">
      View
    </button>
